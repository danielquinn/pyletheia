...
class GifTestCase(TestCase):
    ...
    def test_get_raw_data(self):
        unsigned = os.path.join(self.DATA, "test.gif")
        self.assertEqual(
            md5(JpegFile(unsigned, "").get_raw_data()).hexdigest(),
            "aa41bc501a8c9f8532914524c0b046b6"
        )

        signed = os.path.join(self.DATA, "test-signed.gif")
        self.assertEqual(
    ...
    def test_sign(self):
        ...
        path = self.copy_for_work("test.gif")
    ...
    def test_verify_bad_signature(self):
        ...
        path = self.copy_for_work("test-bad-signature.gif")
    ...
    def test_verify_broken_signature(self):
        ...
        cache = self.cache_public_key()
        path = self.copy_for_work("test-broken-signature.gif")
    ...
    def test_verify(self):
        ...
        path = self.copy_for_work("test-signed.gif")
